<%-- 
    Document   : Profile
    Created on : date, 4:08:36 PM
    Author     : SK
--%>


<%@page import="com.sk.backend.PathDetails"%>
<%@page import="java.io.File"%>
<%@page import="com.sk.connection.DbConnection"%>
                    ...
                    <div class="row"  style="border: 1px solid gray; box-shadow: 0px 0px 2px gray; border-radius: 3px">
                        ...
                        <div class="row">
                            ...
                            if(f.exists())
                            {
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
    <%-- <a href="DownloadResumeBuilder?fn=<jsp:expression>emaill+"pdf"</jsp:expression>" class="z btn-success" > Download Resume </a> --%>
